...
const Template = [
  {
    id: 1,
    Template_name: 'Solsn Technologies',
    status: 'Approved',
    Added_Date: '20 Jan 2025 10.33 AM',
    Added_by: 'Manraj Chauhan',
  },
  {
    id: 2,
    Template_name: 'Solsn Technologies',
  ...
  return (
    ...
    <div className='bg-[#F5F6FA]'>
        <div className='pt-6 px-6'>
            <h1 className='text-2xl font-bold tracking-tight mb-2'>Email Templates</h1>
            <p className='text-wrap text-lg'>Effortlessly create and customize templates to broadcast engaging messages to your <span className='text-green-700'>email.</span></p>
            </div>
      ...
      <table className="min-w-full bg-white table-auto">
        <thead>
          <tr className="border-b">
            ...
            <th className="px-6 py-3 text-left font-semibold text-neutral-900">Added By</th>
        ...
        <tbody>
          {Template.map((Templates) => (
            <tr key={Templates.id} className="hover:bg-green-50 text-neutral-700 text-md">
              ...
              <td className="px-6 py-4 tracking-tight">{Templates.Added_by}</td>
              <td className="px-6 py-4 tracking-tight">{Templates.Added_Date}</td>
