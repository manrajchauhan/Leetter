...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.set(heroImagesRef.current, {
      opacity: 0,
      x: 100,
    });
    ...
    <section className="relative bg-white">
      <div className="px-24 py-10 mx-auto">
        <div className="max-w-lg xl:max-w-xl mx-auto lg:mx-0 pt-12 pb-28 lg:py-20">
          <h1
            ref={headingRef}
            className="font-semibold text-5xl xs:text-7xl xl:text-7xl tracking-tighter mb-8"
          >
          ...
          <p
            ref={paragraphRef}
            className="max-w-md xl:max-w-none text-lg text-gray-700 mb-10"
          >
          ...
          <div ref={buttonsRef} className="flex flex-col sm:flex-row">
            <Link
              href="register"
      ...
      <div
        ref={heroImagesRef}
        className="hidden lg:flex items-center justify-center absolute top-10 right-0 h-full max-w-lg xl:max-w-none xl:w-2/5 p-3 ml-auto bg-transparent"
      >
        <img
          ...
          alt="Hero 2"
        />
        <img className="block xl:h-full mx-auto" src="/hero-1.png" alt="Hero" />
      </div>
